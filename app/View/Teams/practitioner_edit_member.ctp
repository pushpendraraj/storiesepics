<section class="content-header">
  <h1>
    <?php echo __('Edit Team Member');?>
    <small>Edit team member details</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="<?=PRACTITIONER_WEBROOT;?>home"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active"><?php echo __('Edit Team Member');?></li>
  </ol>
</section>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box box-primary">
       ...
       <div class="form-group col-sm-6">
        <label class="col-sm-3 control-label" for="inputPassword3">Member Image</label>
        <div class="col-sm-9">
