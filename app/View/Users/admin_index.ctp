		...
		<div class="col-xs-12">
			<div class="box box-primary">
				...
				<table class="table table-hover">
					<tr>
						<th><?php echo $this->Paginator->sort('full_name', 'User Name');?></th>
					...
					foreach ($Users as $user):
						...
						<tr>
							...
							<td><?php echo ($user['User']['user_status'])?'Active':'Inactive'; ?></td>
							<td><?php echo $this->Html->link(__('View', true), array('action' => 'view', $user['User']['user_id']),array('class'=>'btn btn-default btn-sm btn-info')); ?>
								...
								<?php // echo $this->Html->link(__('Delete', true), array('action' => 'delete', $user['User']['user_id']), array('class'=>'btn btn-default btn-sm btn-danger'), sprintf(__('Are you sure you want to delete %s?', $user['User']['full_name']))); ?>
							</td>
						</tr>
					<?php endforeach; ?>
				</table>
