<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><?php echo __('Add Service');?></li>
  </ol>
</section>
<section class="content">
	<div class="row">
        ...
        <div class="box-body">
          ...
          <label class="col-sm-2 control-label" for="inputPassword3">Service Title</label>
            <div class="col-sm-6">
             <?php echo $this->Form->input('service_title', array('label'=>false,'class'=>'form-control')); ?>
           </div>
         </div>
	...
	<div class="form-group col-sm-12">
      <label class="col-sm-2 control-label" for="inputPassword3">Details Description</label>
      <div class="col-sm-4">
